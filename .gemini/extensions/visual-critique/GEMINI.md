...
- **/visual-critique:anti-slop-audit** — Audit a design artifact for generic AI defaults, fabricated proof, structural sameness, detector findings, token drift, and responsive or accessibility failures.
