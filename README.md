...
Each preview below is an original demonstration generated from the skill's operational rules. It is not a reproduction, an authorized artist or franchise style guide, or a prompt shortcut based only on a name.

<table>
  <tr>
    <td width="50%" valign="top">
      <a href="ui-design/skills/leonora-carrington-style/SKILL.md"><strong>Leonora Carrington Method</strong></a><br>
      <img src="ui-design/examples/artist-derived-methods/assets/leonora-carrington-method.jpg" width="420" alt="Original visual fable showing an autonomous archivist, a rooted key, a witness creature, and a transforming threshold room"><br>
      <sub><strong>Shows:</strong> a world law, autonomous agents, domestic ritual, material metamorphosis, and a room that behaves like a social machine.<br><strong>Use for:</strong> narrative worlds, cultural experiences, editorial series, and transformation-led onboarding.</sub>
    </td>
    <td width="50%" valign="top">
      <a href="ui-design/skills/doraemon-style/SKILL.md"><strong>Fujiko F. Fujio Visual Narrative Method</strong></a><br>
      <img src="ui-design/examples/artist-derived-methods/assets/doraemon-method.jpg" width="420" alt="Original child-readable kitchen story showing a seed device progressing from setup to success to an overgrown consequence"><br>
      <sub><strong>Shows:</strong> controlled curves, single-beat clarity, an everyday science-fiction seam, and a desire-operation-escalation-consequence loop.<br><strong>Use for:</strong> original character systems, child-readable stories, product illustration, and consequence-driven onboarding. Protected characters and gadgets are explicitly excluded.</sub>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <a href="ui-design/skills/jackson-pollock-style/SKILL.md"><strong>Jackson Pollock Method</strong></a><br>
      <img src="ui-design/examples/artist-derived-methods/assets/jackson-pollock-method.jpg" width="420" alt="Original abstract field with gravity-aware arcs, pooled nodes, scraped revisions, dense knots, and quiet intervals"><br>
      <sub><strong>Shows:</strong> action-observation feedback, gravity and viscosity as collaborators, heterogeneous allover structure, and field-to-particle reading.<br><strong>Use for:</strong> expressive campaigns, motion systems, spatial graphics, and material-led image direction without random splatter filters.</sub>
    </td>
    <td width="50%" valign="top">
      <a href="ui-design/skills/lucian-freud-style/SKILL.md"><strong>Lucian Freud Method</strong></a><br>
      <img src="ui-design/examples/artist-derived-methods/assets/lucian-freud-method.jpg" width="420" alt="Original dignified portrait of an older seated woman whose body, chair, floor, and room share visible weight"><br>
      <sub><strong>Shows:</strong> sustained relational observation, paint as bodily structure, contact pressure, reciprocal gaze, and a room that co-constructs the figure.<br><strong>Use for:</strong> portrait direction, editorial imagery, close critique, and material studies with explicit consent and dignity guardrails.</sub>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <a href="ui-design/skills/lucio-fontana-style/SKILL.md"><strong>Lucio Fontana Method</strong></a><br>
      <img src="ui-design/examples/artist-derived-methods/assets/lucio-fontana-method.jpg" width="420" alt="Original gallery installation with a coral membrane, shaped aperture, cobalt cavity, concealed backing, and visitor path"><br>
      <sub><strong>Shows:</strong> surface as threshold, prepared irreversibility, light as spatial material, and a body completing the work through movement.<br><strong>Use for:</strong> installations, product reveals, spatial identity, motion transitions, and progressive disclosure beyond decorative crack effects.</sub>
    </td>
    <td width="50%" valign="top">
      <a href="ui-design/skills/gustav-klimt-style/SKILL.md"><strong>Gustav Klimt Method</strong></a><br>
      <img src="ui-design/examples/artist-derived-methods/assets/gustav-klimt-method.jpg" width="420" alt="Original botanist portrait with a lifelike face and hands held against a geometric botanical material field"><br>
      <sub><strong>Shows:</strong> a living anchor against a roaming pattern field, pose before ornament, materialized light, and a production-ready motif grammar.<br><strong>Use for:</strong> portrait-led campaigns, packaging, exhibitions, and brand systems that need patterned richness without a generic gold filter.</sub>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <a href="ui-design/skills/pieter-bruegel-the-elder-style/SKILL.md"><strong>Pieter Bruegel the Elder Method</strong></a><br>
      <img src="ui-design/examples/artist-derived-methods/assets/pieter-bruegel-method.jpg" width="420" alt="Original high-viewpoint community garden where an approaching storm changes many small acts of work"><br>
      <sub><strong>Shows:</strong> high-viewpoint world organization, seasonal causality, many legible action verbs, layered terrain, and whole-to-detail discovery.<br><strong>Use for:</strong> complex editorial scenes, systems maps, community narratives, and information-rich illustration without class caricature.</sub>
    </td>
    <td width="50%" valign="top">
      <a href="ui-design/skills/hans-holbein-the-younger-style/SKILL.md"><strong>Hans Holbein the Younger Method</strong></a><br>
      <img src="ui-design/examples/artist-derived-methods/assets/hans-holbein-method.jpg" width="420" alt="Original formal portrait of a coastal mapping director with selectively precise evidence objects and material transitions"><br>
      <sub><strong>Shows:</strong> a credibility budget, evidence-based identity objects, role-shaped format, transferable likeness, and bounded uncertainty.<br><strong>Use for:</strong> executive portraiture, institutional editorial systems, provenance-aware profiles, and material-specific product stories.</sub>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <a href="ui-design/skills/titian-style/SKILL.md"><strong>Titian Method</strong></a><br>
      <img src="ui-design/examples/artist-derived-methods/assets/titian-method.jpg" width="420" alt="Original rainy ferry departure scene built through chromatic layers, varied material touch, and an irreversible narrative second"><br>
    ...
    <td width="50%" valign="top">
      <a href="ui-design/skills/edvard-munch-style/SKILL.md"><strong>Edvard Munch Method</strong></a><br>
      <img src="ui-design/examples/artist-derived-methods/assets/edvard-munch-method.jpg" width="420" alt="Original cold seaside waiting scene using directional figures, a blocking rail, an echoing rope, fog, and material grain"><br>
      <sub><strong>Shows:</strong> a relational sequence, compressed emotional residue, lines with directional verbs, motif variation, and material-driven recomposition.<br><strong>Use for:</strong> emotional editorial series, motion states, cultural products, and relationship-led narratives without famous icons or diagnostic claims.</sub>
    </td>
  </tr>
</table>
